            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                   ...
                   <li> <a href="#" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Blog<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="comments.php" class="waves-effect">Categoreis</a>
                            </li>
                        </ul>
                    </li>
                ...
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12"> 
                        <ol class="breadcrumb">
                            ...
                            <li><a href="#">categgory</a></li>
                            <li class="active"> <a href="new-cat.php" class="btn btn-success btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Create New category</a></li>
                        </ol>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title m-b-0">Company categoreis ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
