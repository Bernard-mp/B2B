...
<div class="row">
                <table class='table table-striped table-bordered'>
                    ...
                    <tbody>
                        ...
                        require_once "functions/db.php";
                        $query="SELECT * FROM article, admin, category WHERE id_categorie = category_id AND id = id_author ORDER BY article_id asc ";
...
?>
                        ...
                        <tr>
                            ...
                            <td><img src="../Company_admin/img/article/<?= $row['article_image'] ?>" style="width: 90px; height: 50px;"></td>
