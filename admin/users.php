                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <h3 class="box-title m-b-0">Company Bloggers ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
...
?>
    ...
    <tr>
       ...
       <td><?= $row['date'] ?></td>
        ...
        <td>
            <a class="btn btn-danger" href="assest/delete.php?type=admin&id=<?= $row['id'] ?> ">
