...
<?php ob_start();
    session_start();
      ...
      try{
          $db = new PDO('mysql:dbhost=localhost;dbname=b2b;charset=utf8','root','');
...
<body class="white">
  ...
  <img class="wave" src="img/wave1.png">
		  ...
		  <form class="form-horizontal form-material" id="loginform" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post">
                ...
                <p style="color:red;">  <?php echo $password_err; ?> </p>
           		...
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
           		    	<h5>Password</h5>
           		    	<input type="password" name="pass" class="input" id="myInput" required>
    ...
    <!-- java scripting for password  hide and show (eye)-->
<script>
    function toggle() {
