...
<div class="row">
                <table class='table table-striped table-bordered'>
                    ...
                    <tbody>
                        ...
                        require_once "functions/db.php";
                        $query="SELECT * FROM article, admin, category WHERE id_categorie = category_id AND id = id_author AND id_author='$author_id' ORDER BY article_id DESC ";
...
?>
                        ...
                        <tr>
                            ...
                            <td class="text-break"><?= strip_tags(substr($row['article_content'], 0, 150)) . "..." ?></td>
                            <td><img src="img/article/<?= $row['article_image'] ?>" style="width: 90px; height: 50px;"></td>
