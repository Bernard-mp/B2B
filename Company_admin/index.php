...
<?php
    ...
    $sql_ct = "SELECT * FROM category";
    $query_ct = mysqli_query($connection, $sql_ct);
...
<body>
            ...
            <div class="container-fluid">
                ...
                <?php 
                 ...
                 if (isset($_GET['set'])) {
                   ...
                   <strong>DONE!! </strong><p> Your info has been successfully stored.</p>
                     </div>';
                        }
                            ...
                            <div class="row row-in">
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">Blog Posts</h5> </div>
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br  b-r-none">
                                    <div class="col-in row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right m-t-15 text-megna"><?php echo mysqli_num_rows($query2);?></h3> </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="progress">
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-6">
                                            <h3 class="counter text-right m-t-15 text-primary"><?php echo mysqli_num_rows($query_ct);?></h3> </div>
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <div class="progress">
                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center">
                                <div class="comment-body">
                                    ...
                                    $blogid = $row2["id_article"];
                                       $sql2 = "SELECT * FROM article WHERE article_id='$blogid'";
                                            $querycmt = mysqli_query($connection, $sql2);

                                       while (($row3 = mysqli_fetch_assoc($querycmt)) and ($counter < $max)) {
                                        
                                    echo '                
                                    
                                        <b>'.$row2["comment_username"].'</b>
                                        <h5>Blog Title : '.$row3["article_title"].'</h5>
                                        <span class="mail-desc">
                                        '.$row2["comment_content"].'
                                        </span> <span class="time pull-right">'.$row2["comment_date"].'</span>
                                        </br
                                    ';
                                    $counter++;
                                        } } }
    ...
    $query_posts = mysqli_query($connection, $sql_posts);
                                    ...
                                    ?>
                                       ...
                                       <a href="posts.php?id=<?= $author['id'] ?>" class="btn btn-info btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">View All Posts</a>
                                     </div>
                        </div>
                    </div>
                </div>
    ...
    $(document).ready(function() {
        $.toast({
            heading: 'Welcome to B2B dashboard',
            text: 'view, edit and upload new posts to keep your viewers engaged.',
            position: 'top-right',
            loaderBg: '#ff6849',
            icon: 'info',
            hideAfter: 3700,
